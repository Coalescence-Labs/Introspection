...
export const welcome = {
  hero: {
    label: "mb-6 text-xs uppercase tracking-[0.2em] text-muted-foreground",
    headline:
    ...
    cta: "hero-cta inline-flex h-12 min-w-[200px] items-center justify-center rounded-md bg-accent px-10 py-5 text-base font-semibold text-accent-foreground transition-all duration-[250ms] hover:scale-[1.02] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background sm:text-lg",
    footer:
      "absolute bottom-4 left-0 right-0 z-10 text-center text-sm font-light text-[#555] dark:text-muted-foreground/85",
  },
  card: "w-full max-w-4xl rounded-2xl border border-border/50 bg-foreground/[0.02] px-8 py-10 text-center backdrop-blur-sm sm:px-12 sm:py-12",
  sectionTitle: "text-3xl sm:text-4xl font-bold leading-tight text-foreground sm:text-4xl",
